{{-- Cabecera moderna JAC Boliviano 2000 --}}
    ...
    <div class="card shadow-card rounded-2xl px-4 sm:px-5 py-3 flex items-center gap-3">
      <a href="{{ route('welcome') }}" class="flex items-center gap-3 min-w-0">
        @if (file_exists(public_path('images/logo-jac.png')))
          <img src="{{ asset('images/logo-jac.png') }}" alt="JAC Boliviano 2000" class="h-12 w-12 rounded-full object-contain bg-white p-0.5 ring-1 ring-slate-200 shadow-btn">
        @else
        ...
        <span class="leading-tight min-w-0">
          <span class="block font-display font-bold text-ink text-[15px] sm:text-base truncate">JAC Boliviano 2000</span>

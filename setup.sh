...
# === Diagnostico hacia public/diag.txt (lo leo por web) ===
{
  ...
  timeout 15 php -r 'try{new PDO("mysql:host=localhost;dbname=u636084353_jac2000","u636084353_jac2000","JacBolviano2000.");echo "DB OK\n";}catch(Throwable $e){echo "DB ERROR: ".$e->getMessage()."\n";}' 2>&1
  echo "--- PDO host=127.0.0.1 ---"
  timeout 15 php -r 'try{new PDO("mysql:host=127.0.0.1;dbname=u636084353_jac2000","u636084353_jac2000","JacBolviano2000.");echo "DB OK\n";}catch(Throwable $e){echo "DB ERROR: ".$e->getMessage()."\n";}' 2>&1
  echo ""
  echo "--- migrate ---"
